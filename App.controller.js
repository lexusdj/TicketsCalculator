...
onChange: function (oEvent) {
    ...
    return find(0,0,0,0);
      ...
      //tomar valores
      let iImporte = 0, iVticket1 = 0, iVticket2 = 0;
      //var oImporte = this.byId("Importe").getValue(); 
      iImporte = this.byId("Importe").getValue(); 
      
      //var oVTicket1 = this.byId("Ticket1");
      iVticket1 = this.byId("Ticket1").getValue();

      //var oVTicket2 = this.byId("Ticket2");
      iVticket2 = this.byId("Ticket2").getValue();
      // Output text of calculation
      //var oText = this.byId("Textticket");
      if (iImporte > 0) {
        console.log(`Importe ${iImporte}:\n${findSolution(iImporte,iVticket1, iVticket2)}`);
        }
      //this.byId("Textticket").setText(findSolution(iImporte,iVticket1, iVticket2));}
      else{ MessageToast.show("Por favor introduzca importe");}
    }   
	});
});
